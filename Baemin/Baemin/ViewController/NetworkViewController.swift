...
final class NetworkViewController: UIViewController, Alertable, LoadingIndicatorable {
...
//        textField.addPadding()
    ...
    private func navigateToWelcome(userId: Int, userName: String) {
        let welcomeVC = NetworkWelcomeViewController(id: userId, provider: provider)
